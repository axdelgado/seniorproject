...
alldata2 <- alldata # create copy without age filtering
...
```{r}
save(alldata, file = "~/senior project/alldata.Rdata")
save(alldata2, file = "~/senior project/alldata_allage.Rdata") #filesize ~ 0.12 GB
